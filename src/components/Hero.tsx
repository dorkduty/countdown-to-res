    ...
    <section className="min-h-screen relative flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-8 py-20 text-white relative z-20">
        <motion.div
          ...
          className="max-w-4xl"
        >
          <h1 className="text-3xl sm:text-5xl md:text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 text-left">
            (RES)ET with RES
          </h1>
